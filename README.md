...
基于EMA交叉突破策略的V2.2版本，通过优化追踪止损和止盈参数，实现显著收益提升：

| 股票 | 波动率类别 | 优化前收益 | 优化后收益 | 提升幅度 |
|------|-----------|-----------|-----------|----------|
| 601318 中国平安 | 低波动 | -5.07% | **+5.00%** | **+10.07%** ✅ |
| 000858 五粮液 | 中波动 | -16.67% | **-8.45%** | **+8.22%** ✅ |
| 601888 中国中免 | 高波动 | +10.56% | **+44.98%** | **+34.42%** ✅ |

**核心优化点**:
- 追踪止损激活条件: 1.0 ATR → **1.5 ATR**（减少过早离场）
- 止盈目标: 2.5 ATR → **3.0 ATR**（捕获更大涨幅）
- 夏普比率全面改善，风险控制依然有效

📊 [查看完整报告](EMA_V2_2_OPTIMIZATION_REPORT.md)
...
### v2.6.0 (当前版本)
- 🚀 **EMA V2.2策略优化**: 追踪止损1.5 ATR + 止盈3.0 ATR，3/4测试股票收益显著改善
- 📈 中国平安扭亏为盈（-5.07% → +5.00%），中国中免收益提升34.42%
- 🧹 项目代码整理: 归档旧回测结果，清理过时脚本
